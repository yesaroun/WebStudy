...
<script type="text/javascript">
	...
	$(function()
	{
		$("#sendButton").click(function()
		{
			...
			// $.get("요청URL", {su1:su1, su2:su2, oper:oper}, function(넘겨받은 값)
			//{
			//	$(선택자).html(받은값 처리);
			//});
...
<div><input type="text" id="su1" class="txt txtNum" />
	...
	<select name="" id="oper">
		<option value="add">덧셈</otion>
		<option value="sub">뺄셈</otion>
		<option value="mul">곱셈</otion>
		<option value="div">나눗셈</otion>
	</select>
