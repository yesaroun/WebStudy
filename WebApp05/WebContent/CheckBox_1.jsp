...
<div>
	<form action="CheckBoxOk_1.jsp" method="post">
		...
		<label><input type="checkbox" name="checkGroup" value="임시완">남주혁</label>
		<label><input type="checkbox" name="checkGroup" value="임시완">서강준</label>
		<label><input type="checkbox" name="checkGroup" value="임시완">강동원</label>
		<br>
